...
<section class="home-opening3" style="background-image: url('<?= $bgImage ?>');">
  ...
  <div class="text">
    <div>
      ...
      <p><a class="font-sans-s button py-2 px-3" href="https://app.tornatura.it">Scopri la web app</a></p>
    </div>
  </div>
  <div class="mockups">
  ...
  <div class="container-fluid ">
    <div class="row">
      <div class="col-lg-6 align-self-center my-5">
        ...
        <p class="my-4">
          <a href="<?= page("cos-e-tornatura")->url() ?>" class="font-sans-s button py-2 px-3">Scopri come funziona</a>
        </p>
      ...
      <div class="col-lg-6 offset-lg-1 align-self-center my-5">
        ...
        <p class="my-4">
          <a href="https://app.tornatura.it" target="_blank" class="font-sans-s button py-2 px-3">Apri la web app</a>
        </p>
      </div>
    </div>
  </div>
