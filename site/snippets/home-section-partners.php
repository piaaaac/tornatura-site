...
<section class="">
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-sm-6 col-xl-4 pr-5">
        <div><a target="_blank" href="https://www.confcooperativemiliaromagna.it/" class="d-inline-block" style="max-width: 45%;"><img class="partner-logo" src="<?= $ass ?>/partners3/partner-logo-op-confcooperative.png " alt="Fondo Repubblica Digitale" /></a></div>
        <p><strong>Confcooperative Emilia Romagna</strong></p>
        <p class="font-sans-s"><a target="_blank" href="https://www.confcooperativemiliaromagna.it/" class="icon-web-before color-melma">confcooperativemiliaromagna.it</a></p>
      </div>
